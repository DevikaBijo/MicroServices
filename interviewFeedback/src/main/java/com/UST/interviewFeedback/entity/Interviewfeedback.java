...
public class Interviewfeedback {
    ...
    public Interviewfeedback(Long id, String userid, String candidateName,
                             String position, String interviewerName,
                             String interviewerEmpid, int rating, String status) {
        this.id = id;
        this.userid = userid;
        CandidateName = candidateName;
        Position = position;
